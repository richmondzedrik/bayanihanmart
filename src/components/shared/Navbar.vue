  ...
  <nav class="bg-white shadow">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex">
          <router-link :to="homeRoute" class="flex-shrink-0 flex items-center">
            <span class="text-xl font-bold text-indigo-600">BayanihanMart</span>
          </router-link>
          
          <!-- Seller Navigation -->
          <div v-if="authStore.user?.role === 'seller'" class="ml-6 flex space-x-4">
          ...
          <!-- Buyer Navigation -->
          <div v-if="authStore.user?.role === 'buyer'" class="ml-6 flex space-x-4">
